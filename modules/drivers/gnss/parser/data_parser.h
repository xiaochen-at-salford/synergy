...
// #include "modules/localization/proto/gnss.pb.h"
...
class DataParser {
 ...
 private:
  ...
  void PublishAnSystemState(const MessagePtr message);
  ...
  std::shared_ptr<apollo::cyber::Writer<AnGnss>> an_system_state_writer_ = nullptr;
};
