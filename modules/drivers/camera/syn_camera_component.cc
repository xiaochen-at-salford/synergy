#include "modules/drivers/camera/syn_camera_component.h"

namespace apollo {
namespace drivers {
namespace camera {

bool SynCameraComponent::Init() 
{
  ...
  async_result_ = cyber::Async(&SynCameraComponent::run, this);
  return true;
}

void SynCameraComponent::run() 
{
...
SynCameraComponent::~SynCameraComponent() 
{
  if (running_.load()) 
  {
