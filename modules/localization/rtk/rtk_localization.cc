...
void RTKLocalization::PrepareLocalizationMsg(
    const localization::Gps &gps_msg, LocalizationEstimate *localization, LocalizationStatus *localization_status ) 
{
...
void RTKLocalization::FillLocalizationStatusMsg(
    const drivers::gnss::InsStat &status, LocalizationStatus *localization_status ) 
{
...
void RTKLocalization::ComposeLocalizationMsg(
    const localization::Gps &gps_msg, const localization::CorrectedImu &imu_msg, LocalizationEstimate *localization ) 
{
  localization->Clear();
...
bool RTKLocalization::InterpolateIMU(
    const CorrectedImu &imu1, const CorrectedImu &imu2, 
...
bool RTKLocalization::FindNearestGpsStatus(const double gps_timestamp_sec, drivers::gnss::InsStat *status) 
{
