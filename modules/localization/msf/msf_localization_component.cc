...
bool MSFLocalizationComponent::InitIO() 
{
  ...
  bestgnsspos_register_call = std::bind(&MSFLocalization::OnGnssBestPose, &localization_, std::placeholders::_1);
  ...
  gnss_heading_listener_ = 
      this->node_->CreateReader<drivers::gnss::Heading>( 
...
void LocalizationMsgPublisher::PublishLocalizationMsfGnss(const LocalizationEstimate& localization) 
{ gnss_local_talker_->Write(localization); }

void LocalizationMsgPublisher::PublishLocalizationMsfLidar(const LocalizationEstimate& localization) 
{ lidar_local_talker_->Write(localization); }

void LocalizationMsgPublisher::PublishLocalizationStatus(const LocalizationStatus& localization_status) 
