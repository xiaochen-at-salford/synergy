...
void MSFLocalization::InitParams() 
{
  ...
  else 
  {
    ...
    ACHECK(LoadGnssAntennaExtrinsic(FLAGS_ant_imu_leverarm_file, 
...
void MSFLocalization::OnGnssRtkObs(const std::shared_ptr<drivers::gnss::EpochObservation> &raw_obs_msg) 
{
  if ((localization_state_ == msf::LocalizationMeasureState::OK 
           || localization_state_ == msf::LocalizationMeasureState::VALID ) 
      && FLAGS_gnss_only_init ) 
...
void MSFLocalization::OnGnssRtkEph(const std::shared_ptr<drivers::gnss::GnssEphemeris> &gnss_orbit_msg) 
{
  if ((localization_state_ == msf::LocalizationMeasureState::OK 
          || localization_state_ == msf::LocalizationMeasureState::VALID ) 
      && FLAGS_gnss_only_init ) 
...
void MSFLocalization::OnGnssHeading(const std::shared_ptr<drivers::gnss::Heading> &gnss_heading_msg) 
{
  if ((localization_state_ == msf::LocalizationMeasureState::OK 
          || localization_state_ == msf::LocalizationMeasureState::VALID ) 
      && FLAGS_gnss_only_init ) 
...
void MSFLocalization::CompensateImuVehicleExtrinsic(LocalizationEstimate *local_result) 
{
  ...
  posepb_loc->set_heading(common::math::QuaternionToHeading(
      quat_vehicle_world.w(), quat_vehicle_world.x(), quat_vehicle_world.y(), quat_vehicle_world.z() ) );
