...
const uint32_t KEYCODE_ACTION_START = 0x79;  // 'y'
const uint32_t KEYCODE_ACTION_STOP = 0x6E;  // 'n'
...
const uint32_t KEYCODE_STEERING_ENABLE = 0x58;  // 'X'
const uint32_t KEYCODE_STEERING_DISABLE = 0x78;  // 'x'
...
class Teleop {
 public:
  ...
  static void PrintKeycode() 
  {
    ...
    printf("                     [y] DrivingMode START \n");
    printf("                     [n] DrivingMode STOP \n");
