#include "modules/canbus/syn_canbus_component.h"
...
std::string SynCanbusComponent::Name() const { return FLAGS_canbus_module_name; }

SynCanbusComponent::SynCanbusComponent()
  : monitor_logger_buffer_(apollo::common::monitor::MonitorMessageItem::CANBUS) 
  {}

bool SynCanbusComponent::Init() 
{
...
void SynCanbusComponent::PublishChassis() 
{
...
void SynCanbusComponent::PublishChassisDetail() 
{
...
void SynCanbusComponent::OnControlCommand(const ControlCommand &control_command) 
{
...
void SynCanbusComponent::OnGuardianCommand(const GuardianCommand &guardian_command) 
{ OnControlCommand(guardian_command.control_command()); }

common::Status SynCanbusComponent::OnError(const std::string &error_msg) 
{
